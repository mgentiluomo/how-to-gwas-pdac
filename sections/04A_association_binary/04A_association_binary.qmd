...
demonstration data Firth is invoked for **2,221** variants, all of them low-frequency. With a few
...
The log reports what was actually analysed. On the demonstration data: **229 cases and 396
controls**.
...
On the demonstration data **λ = 1.028**, and λ₁₀₀₀ = 1.098.
...
The deeper point is the one this guide exists to make. At an effective sample size of 580, the
smallest odds ratio detectable with 80% power at genome-wide significance is about 2.2 even for a
...
**1 × 10⁻⁵** is the conventional suggestive line: **8 variants** here. These are not findings and
...
| Effect allele | G, frequency 0.085 |
| Odds ratio | 3.80 (95% CI 2.43 to 5.95) |
| P | 5.3 × 10⁻⁹ |
...
The simulated odds ratio at this variant is **2.40**. The analysis recovered **3.80**, with a
confidence interval whose lower bound, 2.43, sits just above the truth. The estimate is inflated
by roughly 58%.
