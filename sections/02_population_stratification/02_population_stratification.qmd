...
On the demonstration data this keeps **221,352** variants and prunes away **180,557**. Losing
...
How many components carry real signal? On the demonstration data PC1 explains 47.0% of the
variance and PC2 38.1%, then the curve collapses to 3.7% at PC3. That cliff is the signature of
...
4 × cases × controls / (cases + controls) = 580.4, not 625. In an unbalanced design the effective
