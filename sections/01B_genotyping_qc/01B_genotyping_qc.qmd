...
In the demo run, phenotype-aware pruning removed **191 samples**. That is a substantial sample
...
In the demo run this step removed **5,038 variants**, leaving **401,909 variants** and
**1,239 samples**.
