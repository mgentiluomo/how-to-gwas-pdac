...
$$\qquad \operatorname{Var}(G) = 2p(1-p), \text{Fisher information} \;=\; N \times \pi(1-\pi) \times \operatorname{Var}(G)$$

the variability of the genotype (**π(1 − π)**), the sample size (**N**), and the variability of the outcome (**Var(G)**). Multiplying
