...
- **30-45 minutes** to complete all setup steps
...
Throughout the guide, commands that you type into the terminal are shown in blocks like the one
below. Try the following short exercise. It creates a tiny throwaway folder and file, looks at it
in a few different ways, then removes it.
...
3. **The first time only**, Ubuntu asks you to create a username and a password. These are for
   Linux and are unrelated to your Windows account. Choose anything you like, and note that the
   password is invisible as you type it, which is normal, not a frozen terminal.
4. You should see a bash prompt like `user@computer:~$`
...
macOS includes Bash, although Terminal normally opens with Zsh, and most Linux distributions use
Bash by default. Either way the commands in this guide work, and the tutorial scripts are run
explicitly with `bash`. No setup is needed for Step 0.
...
```
::: {.callout-tip title="Tip"}
If you see `rm: remove write-protected regular file 'how-to-gwas-pdac/.git/objects/pack/pack-XXX.rev'?`, type `y` and press <kbd>Enter</kbd> to confirm deletion. This is normal because the cloned repo is write-protected.
:::
...
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/pdac_demo.bed -O demo_data/pdac_demo.bed
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/pdac_demo.bim -O demo_data/pdac_demo.bim
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/pdac_demo.fam -O demo_data/pdac_demo.fam
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/phenotype.txt -O demo_data/phenotype.txt
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/covariates.txt -O demo_data/covariates.txt
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/survival.txt -O demo_data/survival.txt
wget https://github.com/mgentiluomo/how-to-gwas-pdac/releases/download/v0.3-data/sample_ancestry.tsv -O demo_data/sample_ancestry.tsv
```
