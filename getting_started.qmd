...
- Install wget, unzip, tar, and bzip2 if needed
...
The setup script also checks R. If it reports that R is missing, install R before running the setup test. On WSL/Linux you can usually use:
